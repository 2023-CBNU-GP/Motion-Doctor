            ...
            <div className={`w-full h-full flex flex-col justify-center items-center`}>
                <div
                    ...
                    <div className={`flex flex-col gap-4`}>
                        <div className={`font-bold text-lg`}>{title}{title == "로딩 중" &&
                            <svg aria-hidden="true"
                                 className="inline w-5 h-5 mx-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                    ...
                    <div className={`justify-end flex`}>
                        {
                            (uid && type) &&
                            <button className={`bg-color-primary-500 w-[50%]  text-white py-1 rounded-lg`}
                                    onClick={() => {
                                        router.push({
                                            pathname: `/result/${uid}`,
                                            query: {
