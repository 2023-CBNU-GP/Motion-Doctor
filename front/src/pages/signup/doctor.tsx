...
export default function Doctor () {
    const { values, errors, submitting, handleChange, handleSubmit } = useForm({
        initialValues: { license: "", email: "", password: "", emailValue: ""},
        onSubmit: (values) => {
                            ...
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                    ...
                                    <input
                                        ...
                                        className={`${errors.license && "border-color-danger-500"} w-[calc(100%-50px)] focus:outline-none border border-gray-300 rounded-sm pl-1 py-0.5`}
                                    />
