                        ...
                        <form className="flex flex-col gap-4"
                            ...
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                    ...
                                    />
                                    <button onClick={certifyId} type={"button"}
                                            className="bg-stone-500 font-bold text-white min-w-fit py-1 w-[50px]">중복
                                    </button>
                                </div>
                                {errors.id &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.id}</div>}
                                {success.id &&
                                    <div className="text-color-success-500 text-sm pl-[100px]">{success.id}</div>}
                            </div>
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                ...
                                {errors.name &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.name}</div>}
                            </div>
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                ...
                                {errors.license &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.license}</div>}
                            </div>
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                ...
                                {errors.hospitalname && <div
                                    className="text-color-danger-500 text-sm pl-[100px]">{errors.hospitalname}</div>}
                            </div>
                            <div className="flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                    ...
                                    <button onClick={certifyEmail} type="button"
                                            className="bg-stone-500 font-bold text-white min-w-fit py-1 w-[50px]">인증
                                    </button>

                                </div>
                                {errors.email &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.email}</div>}
                            ...
                            <div className=" flex gap-1 flex-col">
                                <div className="flex gap-2 items-center">
                                    ...
                                    />
                                    <button onClick={certifyCode} type={"button"}
                                            className="bg-stone-500 font-bold text-white min-w-fit py-1 w-[50px]">인증
                                    </button>
                                </div>
                                {errors.emailCode &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.emailCode}</div>}
                                {success.emailCode && <div
                                    className="text-color-success-500 text-sm pl-[100px]">{success.emailCode}</div>}
                            </div>
                            ...
                            <div className="flex gap-1 flex-col">
                                ...
                                {errors.password &&
                                    <div className="text-color-danger-500 text-sm pl-[100px]">{errors.password}</div>}
                            </div>
                            ...
                            <div className="flex gap-1 flex-col">
                                ...
                                {errors.checkPassword && <div
                                    className="text-color-danger-500 text-sm pl-[100px]">{errors.checkPassword}</div>}
                            </div>


                            <button className="bg-color-primary-500 text-white font-bold py-0.5" type="submit"
                                    disabled={submitting}>회원가입하기
                            </button>
                        </form>
                    </div>
                </div>
