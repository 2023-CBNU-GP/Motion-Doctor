            ...
            <Layout>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex gap-4 border border-stone-100 p-2">
                        ...
                        <input
                            className="w-[60%] file:mr-3 file:font-semibold file:bg-color-primary-400 file:rounded-sm file:text-white file:border-0"
                            name={"filePath"}
                            type={"file"}
                            ref={inputRef}
                    ...
                    <div className="flex justify-end p-1">
                        <button onClick={submitVideo}
                                className="w-[20%] border border-stone-400 rounded-sm py-1 px-3 hover:bg-stone-400 hover:text-white">제출하기
                        </button>
                    </div>
                </div>
